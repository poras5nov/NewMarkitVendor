...
class GSTDocument extends StatefulWidget {
  BusinessModel model;
  GSTDocument({Key? key, required this.model}) : super(key: key);

  @override
  _GSTDocumentState createState() => _GSTDocumentState();
}

class _GSTDocumentState extends State<GSTDocument> implements ApiInterface {
  ...
  void initState() {
    super.initState();
    getToken();
    if (widget.model.gstNumber != null) {
      panCardController.text = widget.model.gstNumber!;
    }
    if (widget.model.gstImage != null) {
      _imagePath = widget.model.gstImage!;
      _imageDupilcatePath = widget.model.gstDuplicateImage!;
      if (_imagePath != "") {
        isUpload = true;
      }
    }
  ...
  panCardFormFiled() {
    return TextFormField(
      ...
      validator: (v) => Utility.checkGSTValid(v!, context),
      decoration: InputDecoration(
        labelText: NewMarkitVendorLocalizations.of(context)!.find('gstNumber'),
  ...
  validateInput() {
    if (formkey.currentState!.validate()) {
      if (isUpload) {
        widget.model.gstImage = _imagePath;
        widget.model.gstDuplicateImage = _imageDupilcatePath;
        widget.model.gstNumber = panCardController.text;
