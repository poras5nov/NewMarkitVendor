...
class PanCardDocument extends StatefulWidget {
  BusinessModel model;
  PanCardDocument({Key? key, required this.model}) : super(key: key);
  @override
  _PanCardDocumentState createState() => _PanCardDocumentState();
}

class _PanCardDocumentState extends State<PanCardDocument>
  ...
  void initState() {
    super.initState();
    getToken();
    if (widget.model.panNumber != null) {
      panCardController.text = widget.model.panNumber!;
    }
    if (widget.model.panImage != null) {
      _imagePath = widget.model.panImage!;
      _imageDupilcatePath = widget.model.panDuplicateImage!;
      if (_imagePath != "") {
        isUpload = true;
      }
    }
  ...
  validateInput() {
    if (formkey.currentState!.validate()) {
      if (isUpload) {
        ...
        widget.model.panDuplicateImage = _imageDupilcatePath;
