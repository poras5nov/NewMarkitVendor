...
class AdharCardCardDocument extends StatefulWidget {
  BusinessModel model;
  AdharCardCardDocument({Key? key, required this.model}) : super(key: key);
  @override
  _AdharCardCardDocumentState createState() => _AdharCardCardDocumentState();
}

class _AdharCardCardDocumentState extends State<AdharCardCardDocument>
  ...
  void initState() {
    super.initState();
    getToken();
    if (widget.model.aadhaarNumber != null) {
      panCardController.text = widget.model.aadhaarNumber!;
    }
    if (widget.model.aadhaarImage != null) {
      _imagePath = widget.model.aadhaarImage!;
      _imageDupilcatePath = widget.model.aadhaarDuplicateImage!;
      if (_imagePath != "") {
        isUpload = true;
      }
    }
  ...
  validateInput() {
    if (formkey.currentState!.validate()) {
      if (isUpload) {
        widget.model.aadhaarImage = _imagePath;
        widget.model.aadhaarDuplicateImage = _imageDupilcatePath;
        widget.model.aadhaarNumber = panCardController.text;
