...
import 'package:market_vendor_app/activities/order_package/model/all_recent_model.dart';
...
class ViewAllRecentOrderScreen extends StatefulWidget {
  @override
  _ViewAllRecentOrderScreenScreenState createState() =>
      _ViewAllRecentOrderScreenScreenState();
}

class _ViewAllRecentOrderScreenScreenState
    extends State<ViewAllRecentOrderScreen> implements ApiInterface {
  var token;
  AllRecentModel model = AllRecentModel();
  bool isLoader = true;
  List<Data> dataModel = [];
  ...
  getToken() {
    SharedPref.getLoginToken().then((value) {
      ...
      ApiCall.getAllRecentOrderApi(page.toString(), token, this, context);
    });
  }
  ...
  @override
  void onSuccess(data) {
    model = AllRecentModel.fromJson(data);
    if (isBottomLoader) {
