class AllRecentModel {
  ...
  AllRecentModel({this.status, this.message, this.data});

  AllRecentModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? new RecentData.fromJson(json['data']) : null;
  }
...
class ProductJson {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['vendor_rating'] = this.vendorRating;
    return data;
  }
}
