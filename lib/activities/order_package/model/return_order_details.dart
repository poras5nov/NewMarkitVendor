class ReturnOrdersDetails {
  int? status;
  String? message;
  Data? data;

  ReturnOrdersDetails({this.status, this.message, this.data});

  ReturnOrdersDetails.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class ReturnRequest {
  ...
  ReturnReason? declineByVendor;
  String? reject_reason_vendor;
  ...
  ReturnRequest(
      ...
      this.delivery_image,
      this.returnReason,
      this.declineByVendor,
      this.reject_reason_vendor,
      this.returnProducts});
  ...
  ReturnRequest.fromJson(Map<String, dynamic> json) {
    ...
    reject_reason_vendor = json['reject_reason_vendor'].toString();
    ...
    returnReason = json['return_reason'] != null
        ? new ReturnReason.fromJson(json['return_reason'])
        : null;
    declineByVendor = json['decline_by_vendor'] != null
        ? new ReturnReason.fromJson(json['decline_by_vendor'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['status'] = this.status;
    data['reason'] = this.reason.toString();
    data['created_at'] = this.createdAt;
    data['updated_at'] = this.updatedAt;
    data['images'] = this.images;
    data['delivery_image'] = this.delivery_image;
    data['reject_reason_vendor'] = this.reject_reason_vendor;
    if (this.returnReason != null) {
      data['return_reason'] = this.returnReason!.toJson();
    }
    if (this.declineByVendor != null) {
      data['decline_by_vendor'] = this.declineByVendor!.toJson();
    }
...
class ReturnReason {
  ...
  ReturnReason({this.id, this.text, this.createdAt, this.updatedAt});
