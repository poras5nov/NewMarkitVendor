class AllReturnOrders {
  int? status;
  String? message;
  AllData? data;

  AllReturnOrders({this.status, this.message, this.data});

  AllReturnOrders.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    rejectReasonVendor = json['reject_reason_vendor'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['reject_reason_vendor'] = this.rejectReasonVendor;
