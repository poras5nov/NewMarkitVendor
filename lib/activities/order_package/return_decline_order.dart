...
class ReturnDeclineOrderScreen extends StatefulWidget {
  int? id;
  int? rId;
  ReturnDeclineOrderScreen({this.id, this.rId});
  @override
  _ReturnDeclineOrderScreenState createState() =>
      _ReturnDeclineOrderScreenState();
}

class _ReturnDeclineOrderScreenState extends State<ReturnDeclineOrderScreen>
