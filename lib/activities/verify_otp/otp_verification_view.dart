...
class OTPVerificationView extends StatefulWidget {
  String? phone;
  OTPVerificationView({Key? key, this.phone}) : super(key: key);
...
class _OTPVerificationView extends State<OTPVerificationView>
    ...
    if (isResend) {
      ...
      Navigator.pushReplacement(
          ...
          PageTransition(
              ...
              child: BuildYourProfileView(phone: widget.phone!)));
    }
    setState(() {
      isLoader = false;
      isResend = false;
